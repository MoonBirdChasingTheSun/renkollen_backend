...
int bank_number_part = zhang :: bank_number_part(secret_modifier) + khan :: bank_number_part(secret_modifier) + garcia :: bank_number_part(secret_modifier) ;
    ...
    int assemble_code (){
      int matching_code = (zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()) * (zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment());
